...
public class SettleByBusinessWithAmount implements Serializable {
    ...
    /** 业务名称*/
    @Column(name = "businessName", nullable = false, columnDefinition="varchar(50) COMMENT '业务名称'")
    private String businessName;

    /** 业务编码*/
    @Column(name = "businessCode", nullable = false,columnDefinition="varchar(100) COMMENT '业务编码'")
