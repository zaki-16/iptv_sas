...
public class NoteController {
    ...
    @PostMapping("/addNote")
    @ApiOperation(value = "新增备注模板",notes = "返回处理结果，false或true")
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResultVO<?> findByConditions(@ApiParam(value = "备注模板内容") @RequestParam(value = "content",required = false )String content,
